...
var MyLabel = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("span", __assign({ className: "label ".concat(size, " text-").concat(color), style: { backgroundColor: backgroundColor, color: fontColor } }, { children: allCaps ? label.toUpperCase() : label }), void 0));
};
